<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="HumanDemographicGroupsEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.HumanDemographicGroups.HumanDemographicGroupsEnquiries" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="usersCard">
        ...
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/HumanDemographicGroups/HumanDemographicGroupsCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
