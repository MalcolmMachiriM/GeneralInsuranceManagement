<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="MaritalStatusEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.MaritalStatus.MaritalStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="usersCard">
        <h5 class="mb-0 text-uppercase">
            <span><i class="bx bx-user-plus" style="font-size: larger"></i></span>
            Marital Status
        </h5>
        <hr />
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/MaritalStatus/MaritalStatusCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Status" HeaderText="Marital Status"></asp:BoundField>
                            <asp:BoundField DataField="Code" HeaderText="Marital Status Code"></asp:BoundField>
