<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="CurrenciesEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.Currencies.Currencies" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="usersCard">
        <h5 class="mb-0 text-uppercase">
            <span><i class="bx bx-money" style="font-size: larger"></i></span>
            Currencies
        </h5>
        <hr />
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/Currencies/CurrenciesCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Description" HeaderText="Currency"></asp:BoundField>
                            <asp:BoundField DataField="Code" HeaderText="Currency Code"></asp:BoundField>
