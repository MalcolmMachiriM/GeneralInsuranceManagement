<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="InstitutionTypesEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.InstitutionTypes.InstitutionTypes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="usersCard">
        ...
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/InstitutionTypes/InstitutionTypesCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
