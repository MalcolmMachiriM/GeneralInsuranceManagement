<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="ReligionsEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.Religions.Religions" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Religions</div>
        <div class="ps-3">
    ...
    <asp:Panel runat="server" ID="usersCard">
        <h5 class="mb-0 text-uppercase">
            <span><i class="bx bx-church" style="font-size: larger"></i></span>
            Religions
        </h5>
        <hr />
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/Religions/ReligionsCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Name" HeaderText="Religions"></asp:BoundField>
