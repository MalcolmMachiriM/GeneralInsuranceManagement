...
{
    public partial class BusinessDecisionsEnquiries : System.Web.UI.Page
    {
        ...
        private void getBusinessDecisions()
        {
            Models.GlobalParameters.BusinessDecisions businessDecisions = new Models.GlobalParameters.BusinessDecisions("cn", long.Parse(txtuserid.Value));
            string sql = "select * from BusinessDecisions";
            DataSet ds = businessDecisions.GetUsers(sql);
            if (ds != null)
            {
            ...
            else
            {
                ...
                grdAcctypes.DataBind();
                WarningAlert("No Business Decisions found");
            }
        }
