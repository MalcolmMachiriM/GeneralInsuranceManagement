...
{
    public partial class AccountTypesEnquiries : System.Web.UI.Page
    {
        ...
        {
            Models.GlobalParameters.AccountTypes account = new Models.GlobalParameters.AccountTypes("cn",long.Parse(txtuserid.Value));
            string sql = "select * from AccountTypes";
            DataSet ds = account.GetUsers(sql);
            if (ds != null)
            {
            ...
            else
            {
                ...
                grdAcctypes.DataBind();
                WarningAlert("No Account Types found");
            }
        }
