<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="AccountTypesEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.AccountTypes.AccountTypesEnquiries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Account Types</div>
        <div class="ps-3">
    ...
    <asp:Panel runat="server" ID="usersCard">
        ...
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/AccountTypes/AccountTypesCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Type" HeaderText="Account Types"></asp:BoundField>
