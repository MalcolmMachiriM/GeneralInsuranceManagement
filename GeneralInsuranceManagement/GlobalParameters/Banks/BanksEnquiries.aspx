<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="BanksEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.Banks.BanksEnquiries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Banks</div>
        <div class="ps-3">
    ...
    <asp:Panel runat="server" ID="usersCard">
        <h5 class="mb-0 text-uppercase">
            <span><i class="bx bx-buildings" style="font-size: larger"></i></span>
            Banks
        </h5>
        <hr />
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/Banks/BanksCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Code" HeaderText="Bank Code"></asp:BoundField>
                            <asp:BoundField DataField="BankName" HeaderText="Bank Name"></asp:BoundField>
                            <asp:BoundField DataField="NumberOfBranches" HeaderText="Number of Branches"></asp:BoundField>
                            <asp:BoundField DataField="AccountNumberLength" HeaderText="Account Number Length"></asp:BoundField>
