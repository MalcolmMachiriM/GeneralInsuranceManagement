                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <asp:TextBox runat="server" ID="InterestFrequencies" CssClass="form-control" placeholder="Enter Interest Frequency Type" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="InterestFrequencies"
                                    CssClass="text-danger" ErrorMessage="The Interest Rate Frequency is required." />
                            </div>
                        </div>
                        <%-- <div class="col-md-6">
