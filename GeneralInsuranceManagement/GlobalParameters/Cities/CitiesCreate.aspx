<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="CitiesCreate.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.Cities.CitiesCreate" %>
            ...
            <div class="card ">
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <asp:Label runat="server" class="col-sm-3 col-form-label">Country </asp:Label>
                        <div class="col-sm-6">
                        ...
                        <!-- row -->
                        <asp:Label runat="server" class="col-sm-3 col-form-label">City </asp:Label>
                        <div class="col-sm-6">
                            <div class="input-group">
                                <span class="input-group-text"><i class='bx bx-barcode' style="color: blue"></i></span>
                                <asp:TextBox runat="server" ID="CityName" CssClass="form-control" placeholder="Enter Employee Name" />
