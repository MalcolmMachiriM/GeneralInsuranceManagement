...
namespace GeneralInsuranceManagement.GlobalParameters.Qualifications
{
    public partial class Qualifications : System.Web.UI.Page
    {
        ...
        protected void grdAcctypes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("~/GlobalParameters/Qualifications/QualificationsCreate?QualificationsId=" + Id, Id), false);
            }
            if (e.CommandName == "deleteRecord")
            {
                Models.GlobalParameters.Qualifications qualifications = new Models.GlobalParameters.Qualifications("cn", 1);
                if (qualifications.Retrieve(long.Parse(Id)))
                {
