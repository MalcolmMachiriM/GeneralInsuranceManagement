<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="QualificationsEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.Qualifications.Qualifications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Qualifications</div>
        <div class="ps-3">
    ...
    <asp:Panel runat="server" ID="usersCard">
        ...
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/Qualifications/QualificationsCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="QualificationName" HeaderText="Qualifications"></asp:BoundField>
