<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultUIS.Master" AutoEventWireup="true" CodeBehind="IdentificationTypesEnquiries.aspx.cs" Inherits="GeneralInsuranceManagement.GlobalParameters.IdentificationTypes.IdentificationTypesEnquiries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Identification Types</div>
        <div class="ps-3">
    ...
    <asp:Panel runat="server" ID="usersCard">
        <h5 class="mb-0 text-uppercase">
            <span><i class="bx bx-id-card" style="font-size: larger"></i></span>
            Identification Types
        </h5>
        <hr />
        <div class="row; col-sm-3">
            <a runat="server" href="~/GlobalParameters/IdentificationTypes/IdentificationTypesCreate" class="btn btn-primary">Create
            </a>
        </div>
        <br />
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="grdAcctypes" ClientIDMode="Static" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdentificationTypeName" HeaderText="Identification Types"></asp:BoundField>
                            <asp:BoundField DataField="Format" HeaderText="Format"></asp:BoundField>
                            <asp:BoundField DataField="MinimumLengthRequired" HeaderText="Min Length Required"></asp:BoundField>
                            <asp:BoundField DataField="MaximumLengthRequired" HeaderText="Max Length Required"></asp:BoundField>
