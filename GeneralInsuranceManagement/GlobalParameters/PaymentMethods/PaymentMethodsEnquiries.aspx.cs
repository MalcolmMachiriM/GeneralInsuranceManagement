...
{
    public partial class PaymentMethodsEnquiries : System.Web.UI.Page
    {
        ...
        {
            Models.GlobalParameters.PaymentMethod paymentMethod = new Models.GlobalParameters.PaymentMethod("cn", long.Parse(txtuserid.Value));
            string sql = "select * from PaymentMethods";
            DataSet ds = paymentMethod.GetUsers(sql);
            if (ds != null)
            {
            ...
            else
            {
                ...
                grdAcctypes.DataBind();
                WarningAlert("No Payment Methods found");
            }
        }
