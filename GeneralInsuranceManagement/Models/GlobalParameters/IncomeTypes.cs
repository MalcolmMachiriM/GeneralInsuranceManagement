...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class IncomeTypes
    {
        ...
        public IncomeTypes(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_IncomeTypes");
        ...
        public virtual void GenerateSaveParameters(ref Database db, ref DbCommand cmd)
        {
            ...
            db.AddInParameter(cmd, "@IncomeType", DbType.String, mIncomeType);
        }
