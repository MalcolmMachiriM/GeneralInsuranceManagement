...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class Currencies
    {
        ...
        public Currencies(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_Currencies");
        ...
        public virtual void GenerateSaveParameters(ref Database db, ref DbCommand cmd)
        {
            ...
            db.AddInParameter(cmd, "@Rate", DbType.String, mRate);
        }
