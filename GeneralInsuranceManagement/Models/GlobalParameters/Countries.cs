...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class Countries
    {
        ...
        public Countries(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_Countries");
        ...
        public virtual void GenerateSaveParameters(ref Database db, ref DbCommand cmd)
        {
            ...
            db.AddInParameter(cmd, "@CountryName", DbType.String, mCountryName);
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM Countries WHERE ID = " + mId : "SELECT * FROM Countries WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Country not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM Countries WHERE ID = " + mId);
