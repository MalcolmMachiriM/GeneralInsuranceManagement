...
{
    public class RequirementsTypes
    {
        ...
        public RequirementsTypes(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_RequirementsTypes");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM RequirementTypes WHERE ID = " + mId : "SELECT * FROM RequirementTypes WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Requirement Type not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM RequirementTypes WHERE ID = " + mId);
