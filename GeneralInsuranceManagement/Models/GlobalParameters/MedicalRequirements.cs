...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class MedicalRequirements
    {
        ...
        public string Tariff { get { return mTariff; } set { mTariff = value; } }
        ...
        public MedicalRequirements(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_MedicalRequirements");
        ...
        public virtual void GenerateSaveParameters(ref Database db, ref DbCommand cmd)
        {
            ...
            db.AddInParameter(cmd, "@Tariff", DbType.String, mTariff);
        }
        ...
        protected internal virtual void LoadDataRecord(DataRow rw)
        {
            ...
            mTariff = ((rw["Tariff"] != DBNull.Value) ? (rw["Tariff"].ToString()) : "");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM MedicalRequirements WHERE ID = " + mId : "SELECT * FROM MedicalRequirements WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Medical Requirement not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM MedicalRequirements WHERE ID = " + mId);
