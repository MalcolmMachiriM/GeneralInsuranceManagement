...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class InstitutionTypes
    {
        ...
        public InstitutionTypes(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_InstitutionTypes");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM InstitutionTypes WHERE ID = " + mId : "SELECT * FROM InstitutionTypes WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Institution Type not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM InstitutionTypes WHERE ID = " + mId);
