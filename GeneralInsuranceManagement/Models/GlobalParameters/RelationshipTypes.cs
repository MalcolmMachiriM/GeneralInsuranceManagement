...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class RelationshipTypes
    {
        ...
        public RelationshipTypes(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_RelationshipTypes");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM RelationTypes WHERE ID = " + mId : "SELECT * FROM RelationTypes WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Relationship Type not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM RelationTypes WHERE ID = " + mId);
