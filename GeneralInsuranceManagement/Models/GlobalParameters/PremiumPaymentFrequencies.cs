...
{
    public class PremiumPaymentFrequencies
    {
        ...
        public string Frequency { get { return mFrequency; } set { mFrequency = value; } }
        ...
        public PremiumPaymentFrequencies(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_PremiumPaymentFrequencies");
        ...
        public virtual void GenerateSaveParameters(ref Database db, ref DbCommand cmd)
        {
            ...
            db.AddInParameter(cmd, "@Frequency", DbType.String, mFrequency);
        ...
        protected internal virtual void LoadDataRecord(DataRow rw)
        {
            ...
            mFrequency = ((rw["Frequency"] != DBNull.Value) ? (rw["Frequency"].ToString()) : "");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM PremiumPaymentFrequencies WHERE ID = " + mId : "SELECT * FROM PremiumPaymentFrequencies WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Premium Payment Frequency not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM PremiumPaymentFrequencies WHERE ID = " + mId);
