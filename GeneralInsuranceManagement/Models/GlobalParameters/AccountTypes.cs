...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class AccountTypes
    {
        ...
        protected internal virtual void LoadDataRecord(DataRow rw)
        {
            ...
            mType = ((rw["Type"] != DBNull.Value) ? (rw["Type"].ToString()) : "");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM AccountTypes WHERE ID = " + mId : "SELECT * FROM AccountTypes WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Account Type not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM AccountTypes WHERE ID = " + mId);
