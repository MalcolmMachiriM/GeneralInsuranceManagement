...
namespace GeneralInsuranceManagement.Models.GlobalParameters
{
    public class Languages
    {
        ...
        public Languages(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_Languages");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM Languages WHERE ID = " + mId : "SELECT * FROM Languages WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Language not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM Languages WHERE ID = " + mId);
