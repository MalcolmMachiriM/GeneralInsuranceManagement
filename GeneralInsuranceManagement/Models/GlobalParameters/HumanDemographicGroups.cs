...
{
    public class HumanDemographicGroups
    {
        ...
        public HumanDemographicGroups(string ConnectionName, long ObjectUserID)
        {
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("sp_Save_HumanDemographicGroups");
        ...
        {
            string text = ID <= 0 ? "SELECT * FROM HumanDemographicGroups WHERE ID = " + mId : "SELECT * FROM HumanDemographicGroups WHERE ID = " + ID;
        ...
        protected virtual bool Retrieve(string sql)
        {
            try
            {
                ...
                SetErrorDetails("Human Demographic Group not found.");
                return false;
            }
            catch (Exception ex)
            {
        ...
        public virtual bool Delete()
        {
            ...
            return Delete("DELETE FROM HumanDemographicGroups WHERE ID = " + mId);
